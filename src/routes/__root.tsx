...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "FlairTech Solutions delivers Business Intelligence, ERP, Cloud Infrastructure, QA, and Database services to enterprise clients across the US and India." },
      { property: "og:title", content: "FlairTech Solutions" },
      { property: "og:description", content: "Enterprise IT consulting — BI, ERP, Cloud, QA, and Database services." },
